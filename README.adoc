...
Browser:: https://www.mozilla.org/en-US/firefox/new[firefox] (with https://addons.mozilla.org/en-US/firefox/addon/tokyonight_vim[this theme])
...
- solarized-dark-colorpack (specifically solarized-dark-orange-3.36)
- trash-cli
- unclutter
- wget
- xprop
